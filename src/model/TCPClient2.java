...
import model.exceptions.AbmeldenNichtMöglichException;
...
public class TCPClient2 extends Thread{
	...
	public void anmelden() throws IllegalAccessException, IOException{
		...
		answer = readFromServer(); // Willkommensgruß
		nachrichtenVerlauf.append("\n"+answer);
	 ...
	 * @throws IOException
	 * @throws AbmeldenNichtMöglichException 
	 */
	public void abmelden() throws IOException, AbmeldenNichtMöglichException{
        String modifiedSentence; // vom Server modifizierter String
		try {
            ...
            if (modifiedSentence.startsWith("CLIENT_QUIT:OK")){
            	...
            	throw new AbmeldenNichtMöglichException();
            }
