...
public class TCPServer {
   ...
   /**
    * Startet dem Server und k�mmert sich darum, dass jedem neuen Client ein neuer WorkerThread zugewiesen wird.
    */
   public void startServer() {
      ...
      try {
         ...
         while (serviceRequested) { 
            ...
            connectionSocket.setSoLinger(true, 0); // erm�glicht ein schnelleres Schlie�en des Sockets
    ...
    * Mithilfe dieser Methode kann man eine Nachricht hinzuf�gen.
   ...
   /**
    * Gibt Auskunft dar�ber, ob ein Chatname bereits vergeben wurde.
    ...
    * Mithilfe diser Methode kann man neue Teilnehmer in den Raum einf�gen.
    * @param userProtocol Ein Protokoll, um den User bekannt zu geben. Muss die Form "ChatName:hierNameEinf�gen" besitzen.
    * @return den tats�chlichen Chatnamen
    * @throws UnknownUserException Wenn das Protokoll nicht richtig gelesen werden kann.
    * @throws IllegalArgumentException Wenn der Name ung�ltig ist. (Zum Beispiel ein leerer Name)
